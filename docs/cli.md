...
selfgraph render portfolio                   # single-turn render
...
your browser. Same for the static portfolio site. The CLI is also the
only practical surface for CI: GitHub Actions doesn't run Claude Code,
