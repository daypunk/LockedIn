...
| 英文レジュメを書く | `/lockedin-render-resume-en` | 経歴から引いてペルソナに合わせた英文レジュメを書きます。内蔵ペルソナは us-tech-senior、us-tech-mid、pm-product の 3 種で、他の職種でも動きます。指標密度、動詞品質、構造、お決まり表現、ペルソナ適合性の 5 次元で採点し、内蔵外の職種ではペルソナ次元のみ控えめに評価されます。 |
