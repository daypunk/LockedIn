"""selfgraph init --non-interactive --fixture FILE — deterministic vault seed.
...
def _import_yaml():
    try:
        ...
        print(
            "selfgraph init --fixture requires PyYAML. Install one of:\n"
            "  uv pip install PyYAML\n"
            '  pip install "selfgraph[yaml]"\n'
            '  pip install "selfgraph[all]"',
            file=sys.stderr,
        )
        return None
