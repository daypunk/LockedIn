...
- **하나의 그래프, 여러 렌더.** 영문 이력서, 한국 자소서, 정적 포트폴리오
  사이트, 인터랙티브 그래프 viz — 모두 같은 vault에서.
...
Pre-alpha. 스킬 scaffold와 CLI surface 완료. 렌더러 prompt와 rubric은
v0.1 foundational; ontology는 v0.2 (15 entity types, 15 edge predicates,
JSON Resume / Schema.org / FOAF 정렬).
