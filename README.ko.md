...
| 영문 이력서 작성 | `/lockedin-render-resume-en` | 경험에서 가져와 페르소나에 맞춘 영문 이력서를 씁니다. 빌트인 페르소나는 us-tech-senior, us-tech-mid, pm-product 셋이고, 그 외 직무도 동작합니다. 지표 밀도, 동사 품질, 구조, 진부 표현, 페르소나 적합성 5차원으로 채점합니다. |
