...
**Triggers**: `/lockedin init`, ambiguities surfaced during ingest, gaps
...
- Question bank lives at `lockedin/skill/templates/<domain>/questions.yaml`.
...
**Triggers**: passively after ingest; explicitly via `/lockedin validate`.
**Discipline**:
